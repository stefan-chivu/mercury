...
LOCAL_APPS = ["mercury.core", "mercury.users"]
...
DATABASES = {
    "default": env.db("DATABASE_URL", default="postgres:///mercury")
}
...
ACCOUNT_FORMS = {"signup": "mercury.users.forms.UserSignupForm"}
